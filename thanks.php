...
<script type="text/javascript" src="jss/jquery-latest.pack.js"></script>
    	...
    	<div id="inner">
          ...
          <div id="inner3">
            ...
            <div id="innerColmLeft2">
                ...
                <div class="contactUs">
                	<div>
                    	Your request has been sent successfully and one of our representative will contact you soon. If you have urgent queries, you can call us at <b>707-748-5537</b> between 08:00AM to 05:00PM and we will be happy to assist you.<br /><br />
                    	Thank you for choosing DST Controls.
...
function ValidateForm()
{
	...
	if(document.frmcti.name.value=="")
	{
		alert("Please enter name");
		document.frmcti.name.focus();
		return false;
	}

		var emailID=document.frmcti.email
...
if(document.frmcti.phoneno.value=="")
	{
		alert("Please enter phone no");
		document.frmcti.phoneno.focus();
		return false;
	}

	
	if(document.frmcti.address1.value=="")
	{
		alert("Please enter address1");
		document.frmcti.address1.focus();
		return false;
	}
	
	
	if(document.frmcti.city.value=="")
	{
		alert("Please enter city name");
		document.frmcti.city.focus();
		return false;
	}


	if(document.frmcti.state.value=="")
	{
		alert("Please enter state name");
		document.frmcti.state.focus();
		return false;
	}
	
	

if(document.frmcti.zip_code.value=="")
	{
		alert("Please enter zip code ");
		document.frmcti.zip_code.focus();
		return false;
	}
/*

if(document.frmcti.home_phone.value=="")
	{
		alert("Please enter home phone ");
		document.frmcti.home_phone.focus();
		return false;
	}
*/
	...
	if(document.frmcti.address.value=="")
	{
		alert("Please enter address");
		document.frmcti.address.focus();
		return false;
	}
	if(document.frmcti.city.value=="")
	{
	...
	if(document.frmcti.zipcode.value=="")
	{
		alert("Please enter zip code");
		document.frmcti.zipcode.focus();
		return false;
	}
	 ...
	 if(document.frmcti.phoneno.value == "" || document.frmcti.phoneno.value.length < 13  )
	{
	...
	if(document.frmcti.company.value=="")
	{
		alert("Please enter company name");
		document.frmcti.company.focus();
		return false;
	}
	
	if(document.frmcti.contents.value=="")
	{
		alert("Please enter description");
		document.frmcti.contents.focus();
		return false;
	}
	
	
	if(document.frmcti.txt_file.value=="")
	{
		alert("Please select cv");
		document.frmcti.txt_file.focus();
		return false;
	}*/

	
	document.frmcti.submit();
